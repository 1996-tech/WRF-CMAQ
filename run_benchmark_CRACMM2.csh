...
# ===================================================================
  ...
  setenv LD_LIBRARY_PATH /data/lab/meng/priom_zarrah/CMAQv5.5/build/LIBRARIES_intel/lib:${LD_LIBRARY_PATH}
  setenv LD_LIBRARY_PATH /data/lab/meng/priom_zarrah/CMAQv5.5/build/LIBRARIES_intel/netcdf-fortran-4.5.3/fortran/.libs:${LD_LIBRARY_PATH}
  #> Set MPI environment variables
  #> Set to single process (serial) mode
  @ NPCOL = 1
  @ NPROW = 1
  @ NPROCS = 1
  setenv NPCOL_NPROW "1 1"
  #> Run with explicit MPI environment flags
  setenv I_MPI_PMI_LIBRARY /lib64/libpmi.so
  setenv I_MPI_FABRICS shm
  setenv I_MPI_OFI_PROVIDER mlx
  ( /opt/apps/intel/25.0/mpi/2021.14/bin/mpirun -np $NPROCS -genv I_MPI_FABRICS shm -genv I_MPI_OFI_PROVIDER mlx $BLD/$EXEC ) |& tee buff_${EXECUTION_ID}.txt
